...
function MinigameSelector:enter()
    ...
    local gameNames = {'Taupe', 'Game 2', 'Game 3', 'Game 4', 'Game 5', 'Popup', 'Stocks', 'Taiko', 'Burger', 'Time Matcher', 'Stick Catch', 'Wait (Cactus)', 'Runner Dash', 'Find Different', 'Space_Invader' }
